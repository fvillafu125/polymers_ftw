...
class PolymerSmilesTokenizer(RobertaTokenizer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
         ...
         # Check that vocab_file exists and is readable
        ...
        # print(f"Loaded vocab file: {vocab_file}, number of tokens: {len(self.encoder)}")  # Add this line
        ...
        # print(f"Loaded merges file: {merges_file}, number of merges: {len(bpe_merges)}")  # Add this line
